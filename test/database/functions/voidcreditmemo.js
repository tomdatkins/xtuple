(function () {
  ...
  describe("voidCreditMemo(integer, integer, boolean)", function () {
    ...
    it("needs the credit memo posted", function (done) {
    ...
    it("needs the postCreditMemo itemlocseries posted", function (done) {
    ...
    it.skip("should fail if pPreDistributed and pItemlocSeries is null"); 
    it.skip("should fail if cmhead is not found"); 
    it.skip("should fail if aropen is not found"); 
    it.skip("should fail if arapply is not found"); 
    it.skip("should fail if salesaccnt is not found");
