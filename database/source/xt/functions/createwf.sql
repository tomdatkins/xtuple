CREATE OR REPLACE FUNCTION xt.createwf(text, record)
  RETURNS record AS
$CREATEWF$
...
BEGIN
   ...
   SELECT fetchmetricbool('TriggerWorkflow') INTO _metric;
   IF (_metric) THEN
      ...
      ELSE IF (tg_table_name = 'prj') THEN
         _wftypecode := 'PRJ';
      ...
      ELSE IF (tg_table_name = 'poheadext') THEN
         _wftypecode := 'PO';
      ...
      ELSE IF (tg_table_name = 'tohead') THEN
         _wftypecode := 'TO';
