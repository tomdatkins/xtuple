...
select xt.add_column('doctype','doctype_key_param',    'TEXT',   'NOT NULL', 'public');
select xt.add_column('doctype','doctype_uiform_name',  'TEXT',   'NOT NULL', 'public');
select xt.add_column('doctype','doctype_create_priv',  'TEXT',   'NOT NULL', 'public');
