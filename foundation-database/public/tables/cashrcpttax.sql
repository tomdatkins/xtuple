...
ALTER TABLE public.cashrcpttax DISABLE TRIGGER ALL;
...
ALTER TABLE public.cashrcpttax ENABLE TRIGGER ALL;

COMMENT ON TABLE cashrcpttax IS 'Tax History table for Miscellaneous Receipts';
