...
COMMENT ON COLUMN public."char".char_addresses IS 'DEPRECATED - replaced by a row in the charuse table with target_type ADDR';
COMMENT ON COLUMN public."char".char_contacts IS 'DEPRECATED - replaced by a row in the charuse table with target_type CNTCT';
COMMENT ON COLUMN public."char".char_crmaccounts IS 'DEPRECATED - replaced by a row in the charuse table with target_type CRMA';
COMMENT ON COLUMN public."char".char_customers IS 'DEPRECATED - replaced by rows in the charuse table with target_types C and CT';
COMMENT ON COLUMN public."char".char_employees IS 'DEPRECATED - replaced by a row in the charuse table with target_type EMP';
COMMENT ON COLUMN public."char".char_incidents IS 'DEPRECATED - replaced by a row in the charuse table with target_type INCDT';
COMMENT ON COLUMN public."char".char_invoices IS 'DEPRECATED - replaced by a row in the charuse table with target_type INV';
COMMENT ON COLUMN public."char".char_items IS 'DEPRECATED - replaced by a row in the charuse table with target_type I';
COMMENT ON COLUMN public."char".char_lotserial IS 'DEPRECATED - replaced by rows in the charuse table with target_types LS and LSR';
COMMENT ON COLUMN public."char".char_opportunity IS 'DEPRECATED - replaced by a row in the charuse table with target_type OPP';
COMMENT ON COLUMN public."char".char_projects IS 'DEPRECATED - replaced by a row in the charuse table with target_type PROJ';
COMMENT ON COLUMN public."char".char_purchaseorders IS 'DEPRECATED - replaced by a row in the charuse table with target_type PO';
COMMENT ON COLUMN public."char".char_quotes IS 'DEPRECATED - replaced by a row in the charuse table with target_type QU';
COMMENT ON COLUMN public."char".char_salesorders IS 'DEPRECATED - replaced by a row in the charuse table with target_type SO';
COMMENT ON COLUMN public."char".char_tasks IS 'DEPRECATED - replaced by a row in the charuse table with target_type TASK';
COMMENT ON COLUMN public."char".char_vendors IS 'DEPRECATED - replaced by a row in the charuse table with target_type V';
COMMENT ON COLUMN public."char".char_vouchers IS 'DEPRECATED - replaced by a row in the charuse table with target_type VCH';
