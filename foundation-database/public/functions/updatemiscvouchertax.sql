...
BEGIN
   ...
   -- want duplicates
   CREATE TEMPORARY TABLE _vodisttax (vodisttax_vohead_id integer, vodisttax_tax_id integer, vodisttax_tax_code text, vodisttax_amount numeric);
   ...
   LOOP  
	...
	ORDER BY taxdetail_taxclass_sequence DESC
     LOOP
       INSERT INTO _vodisttax (vodisttax_vohead_id, vodisttax_tax_id, vodisttax_tax_code, vodisttax_amount)
         VALUES (pVoHeadid, _taxd.taxdetail_tax_id, _taxd.taxdetail_tax_code, _taxd.taxdetail_tax);
