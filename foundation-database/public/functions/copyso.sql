...
--      coitem_lastupdated,
    ...
    ( _soitemid,
      ...
      CASE WHEN (fetchMetricText('WholesalePriceCosting') = 't') THEN (select (item_listcost) from item where item_id=_soitem.itemsite_item_id) ELSE stdCost(_soitem.itemsite_item_id) END,
