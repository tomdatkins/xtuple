...
BEGIN
  ...
  SELECT fincharg.* INTO _fc FROM fincharg;
  IF (NOT FOUND) THEN
    RAISE EXCEPTION 'Could not find a finance charge record [xtuple: assessFinanceCharge, -1, %]',
                    pAropenid;
  END IF;

  SELECT aropen_docnumber, aropen_amount, aropen_paid, aropen_duedate
    INTO _ar
    FROM aropen
   WHERE aropen_id = pAropenid;
  IF (NOT FOUND) THEN
    RAISE EXCEPTION 'Could not find the A/R Open record [xtuple: assessFinanceCharge, -2, %]',
                    pAropenid;
  END IF;

  INSERT INTO invchead
    ( invchead_cust_id, invchead_shipto_id, invchead_ordernumber,
      invchead_orderdate, invchead_posted, invchead_printed,
      ...
      invchead_shipto_state, invchead_shipto_zipcode, invchead_shipto_phone,
      invchead_salesrep_id, invchead_commission, invchead_terms_id,
      invchead_freight,
      ...
      invchead_prj_id, invchead_curr_id, invchead_gldistdate,
      invchead_recurring, invchead_recurring_interval, invchead_recurring_type,
      invchead_recurring_until, invchead_recurring_invchead_id,
      invchead_shipchrg_id, invchead_taxzone_id, invchead_void,
      invchead_saletype_id, invchead_shipzone_id )
  SELECT
      invchead_cust_id, invchead_shipto_id, invchead_ordernumber,
      invchead_orderdate, FALSE, FALSE,
      fetchInvcNumber(), pAssessDate, invchead_shipdate,
      invchead_ponumber, invchead_shipvia, invchead_fob,
      invchead_billto_name,
      invchead_billto_address1, invchead_billto_address2,
      invchead_billto_address3, invchead_billto_city,
      ...
      invchead_shipto_address3, invchead_shipto_city,
      invchead_shipto_state, invchead_shipto_zipcode, invchead_shipto_phone,
      invchead_salesrep_id, 0.0, invchead_terms_id,
      0.0,
      0.0, NULL, NULL,
      0.0, NULL,
      '',
      invchead_billto_country, invchead_shipto_country,
      invchead_prj_id, invchead_curr_id, NULL,
      FALSE, NULL, NULL,
      NULL, NULL,
      invchead_shipchrg_id, invchead_taxzone_id, invchead_void,
      invchead_saletype_id, invchead_shipzone_id
  ...
  INSERT INTO invcitem
    ( invcitem_invchead_id, invcitem_linenumber, invcitem_item_id,
      invcitem_warehous_id, invcitem_custpn, invcitem_number,
      invcitem_descrip,
      invcitem_ordered, invcitem_billed,
      invcitem_custprice, invcitem_price, invcitem_notes,
      invcitem_salescat_id, invcitem_taxtype_id,
  ...
  VALUES
    ( _invcheadid, 1, -1,
      -1, NULL, _fc.fincharg_markoninvoice,
      ...
      1.0, 1.0,
      pAssessAmount, pAssessAmount, '',
      _fc.fincharg_salescat_id, NULL,
      NULL, 1.0,
      NULL, 1.0,
      NULL, FALSE, _fc.fincharg_accnt_id );
