...
CREATE OR REPLACE RULE "_INSERT" AS
  ...
  INSERT INTO itemsrcp (
    ...
    VALUES(
    getItemSrcId(new.item_number,new.vendor,new.effective,new.expires),
    new.qty_break,
    new.price_per_unit,
...
CREATE OR REPLACE RULE "_UPDATE" AS 
  ...
  WHERE (itemsrcp_itemsrc_id=getItemSrcId(old.item_number,new.vendor,old.effective,old.expires)
...
CREATE OR REPLACE RULE "_DELETE" AS 
  ...
  WHERE (itemsrcp_itemsrc_id=getItemSrcId(old.item_number,old.vendor,old.effective,old.expires)
  AND (itemsrcp_qtybreak=old.qty_break));
