...
CREATE OR REPLACE RULE "_INSERT" AS
  ...
  INSERT INTO itemsrcp (
    ...
    VALUES(
    getItemSrcId(new.item_number,new.vendor,new.vendor_item_number),
    new.qty_break,
    new.price_per_unit,
...
CREATE OR REPLACE RULE "_UPDATE" AS 
  ...
  WHERE (itemsrcp_itemsrc_id=getItemSrcId(old.item_number,new.vendor,new.vendor_item_number)
