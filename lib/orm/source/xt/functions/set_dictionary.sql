...
return (function () {
  ...
  var isDatabase = (context === '_database_') ? true : false,
    ...
    extensions,
    extensionId = null,
    sqlCount = "select count(*) as count from xt.dictobsolete where dict_language_name = $1 " +
    ...
    sqlUpdate = "update xt.dictobsolete set dict_strings = $1 " +
    ...
    sqlInsert = "insert into xt.dictobsolete " +
