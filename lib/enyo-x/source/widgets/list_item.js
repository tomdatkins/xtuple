(function () {
  ...
  enyo.kind(/** @lends XV.ListItem# */ {
    ...
    components: [
      ...
      {kind: "moon.Divider", content: "divider"},
      {kind: "XV.ListColumn", components: [
        {kind: 'font.IconButton', icon: 'check-sign', name: "scanItem",
          style: "width: 8px; height: 8px;", disabled: true, showing: false},
        {kind: 'font.IconButton', icon: 'check-sign', name: "scanLoc",
          style: "width: 8px; height: 8px;", disabled: true, showing: false},
        {kind: 'font.IconButton', icon: 'check-sign', name: "scanLs",
          style: "width: 8px; height: 8px;", disabled: true, showing: false}
      ]}
    ],
    create: function () {
    ...
    handleScannedItem: function (inSender, inEvent) {
      // TODO - add the checkboxes on the row(s)/item(s)
    },
    /**
