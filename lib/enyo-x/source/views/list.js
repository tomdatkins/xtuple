  ...
  enyo.kind(_.extend(/** @lends XV.List# */{
    ...
    */
    doPrint: function (options) {
      var that = this,
        ...
        callback = function (resp) {
          console.log("doPrint callback to new tab: " + resp);
        };
      ...
      var print = function (params) {
        ...
        if (printer && printer !== "Browser") {
          ...
          that.openReport(XT.getOrganizationPath() + reportUrl + rptParams, callback);
        }
      };
    ...
    openReport: function (path, callback) {
      ...
      // Hack to return 'success' for browser printed routes.
      newTab.onload = function () {
        console.log("in the onload function");
        setTimeout(function () {
          if (window.document.docType === "application/pdf") {
            return true;
          }
          return false;
        }, 2000);
