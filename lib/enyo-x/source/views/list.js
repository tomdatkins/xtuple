  ...
  enyo.kind(_.extend(/** @lends XV.List# */{
    ...
    */
    doPrint: function (options) {
      ...
      if (printer && printer !== 'Browser') { // send it to be printed silently by the server
        ...
        model.doPrint(options);
      } else { // TODO - This is not working when printing multiple reports
        this.openReport(XT.getOrganizationPath() + model.getReportUrl());
      }
    },
    /**
