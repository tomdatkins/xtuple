...
(function () {
  ...
  enyo.kind(_.extend(/** @lends XV.List# */{
    ...
    */
     ...
     */
    doDownload: function (inEvent) {
      inEvent.reportAction = "download";
      inEvent.kind = this;
      this.doGenerateReport(inEvent);
    },
    /**
      If email is available, email the report. Otherwise, show the report in
      another tab.
     */
    doEmail: function (inEvent) {
      inEvent.reportAction = "email";
      inEvent.kind = this;
      this.doGenerateReport(inEvent);
    },
    /**
    ...
    */
    doPrint: function (inEvent) {
      inEvent.reportAction = "print";
      inEvent.kind = this;
      this.doGenerateReport(inEvent);
    },
