    ...
    IF ( (_c.catconfig_warehous_id = -1) OR (_c.catconfig_warehous_id = _warehous.warehous_id) ) THEN
      ...
      VALUES
        ( _itemid, _warehous.warehous_id, 0.0,
          ...
          _c.catconfig_loccntrl, COALESCE(_c.catconfig_location_id, -1), _c.catconfig_location,
          _c.catconfig_recvlocation_id, _c.catconfig_issuelocation_id,
          COALESCE(_c.catconfig_location_dist, false), _c.catconfig_recvlocation_dist, _c.catconfig_issuelocation_dist,
          '', '',
