...
/* CHECK FOR DISTRIBUTION EDITION (MULTISITE) */
var isdist_qry = "SELECT EXISTS(SELECT * FROM information_schema.tables " +
  "WHERE table_schema = 'xt' AND table_name = 'sitetypewf') AS test"
var isdist_result = toolbox.executeQuery(isdist_qry);
if (isdist_result.first())
  var isdist = isdist_result.value('test');

/* CHECK FOR MANUFACTURING EDITION */
