    ...
    schema: [
        {name: "SOByPeriod",  //Backlog
          ...
          dimensions: [{title: "salesRep", name: "Account Rep", nameProperty: "Account Rep Name", codeHier: "[Account Rep.Account Reps by Code].[Account Rep Code]"},
                     ...
                     {title: "productCategory", name: "Product.Products by Category by Code", nameProperty: "Category Name", codeHier: "[Product.Products by Category by Code].[Product Code]"},
                     {title: "classCode", name: "Product.Products by Class by Code", nameProperty: "Class Name", codeHier: "[Product.Products by Class by Code].[Product Code]"},
        ...
        {name: "SODelivery", //Shipment
          ...
          dimensions: [{title: "salesRep", name: "Account Rep", nameProperty: "Account Rep Name", codeHier: "[Account Rep.Account Reps by Code].[Account Rep Code]"},
                     ...
                     {title: "productCategory", name: "Product.Products by Category by Code", nameProperty: "Category Name", codeHier: "[Product.Products by Category by Code].[Product Code]"},
                     {title: "classCode", name: "Product.Products by Class by Code", nameProperty: "Class Name", codeHier: "[Product.Products by Class by Code].[Product Code]"},
                     {title: "itemType", name: "Product.Products by Type by Code", nameProperty: "Type Name", codeHier: "[Product.Products by Type by Code].[Product Code]"},
                     {title: "shipRegion", name: "Ship City", nameProperty: "Region Name", codeHier: "[Ship City.Ship Region].[Region Code]"},
                     {title: "billRegion", name: "Bill City", nameProperty: "Region Name", codeHier: "[Bill City.Bill Region].[Region Code]"}],
