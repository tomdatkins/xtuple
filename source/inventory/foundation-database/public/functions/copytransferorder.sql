...
BEGIN
  ...
  INSERT INTO tohead (tohead_number,
                      tohead_status,
		      tohead_orderdate,
		      ...
		      fetchNextNumber('ToNumber'),
                      CASE WHEN (_head.tohead_status='U') THEN 'U' ELSE 'O' END,
		      CURRENT_DATE,
  ...
  INSERT INTO toitem (toitem_tohead_id,	toitem_linenumber,	toitem_item_id,
		      ...
		      toitem_freight,	toitem_freight_curr_id,
                      ...
                      CASE WHEN (toitem_status='U') THEN 'U' ELSE 'O' END,
