-- PO Email Profile table definition

select xt.create_table('poemlprofile', 'xtcore', false, 'xt.emlprofile');
...
comment on table xtcore.poemlprofile is 'Table for purchase email profiles';
