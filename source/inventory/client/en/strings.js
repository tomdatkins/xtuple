...
(function () {
  ...
  var lang = XT.stringsFor("en_US", {
    ...
    "_item:": "Item: ",
    "_itemScanReqMessage": "Item scan required first. No match for: ",
    ...
    "_locationScanReqMessage": "Location scan required. No match for: ",
    ...
    "_none": "None",
    "_noDetailDistributionRecordSelected": "No detail distribution record selected",
    "_noItem": "No Item",
    ...
    "_postTransferOrderChanges": "Post Tranfer Order Changes",
    ...
    "_request#": "Request #",
    "_requests": "Requests",
    "_requiredDetailFulfilled": "The required detail attributes have been entered/scanned",
    ...
    "_transitSiteSettings": "Transit Site Settings",
    ...
    "_validDefaultLocation": "You have indicated that this Item Site should be Multiple Location Controlled and there is existing quantity on hand." +
      "You must select a default location for the on hand balance to be relocated to.",
