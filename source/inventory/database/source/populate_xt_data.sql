do $$ 
  ...
  plv8.execute('select xt.post(\'{"nameSpace":"XM","type":"Site","id":"WH2","data":{"siteType":"MFG","contact":null,"address":null,"taxZone":null,"comments":[],"costCategory":null,"shipVia":null,"zones":[],"code":"WH2","isActive":true,"description":"Warehouse 2"},"binaryField":null,"requery":false,"username":"admin","encryptionKey":"this is any content"}\');');
