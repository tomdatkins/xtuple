...
//  Set Quality Test numbering
  plv8.execute('select xt.post(\'{"nameSpace":"XM","type":"Manufacturing","dispatch":{"functionName":"commitSettings","parameters":[[{"op":"replace","path":"/NextQualityTestNumber","value":550001},{"op":"replace","path":"/QTNumberGeneration","value":"A"}]]},"encoding":"rjson","username":"admin","encryptionKey":"putanythinghere"}\');');
