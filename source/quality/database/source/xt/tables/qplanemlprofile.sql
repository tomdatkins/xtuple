...
comment on table xt.qplanemlprofile is 'Table for Quality Plan email profiles';

-- this priv does not exist in postbooks so create it here
select xt.add_priv('MaintainQualityPlanEmailProfiles', 'Can Maintain Quality Plan Email Profiles', 'Manufacture', 'Manufacture');
