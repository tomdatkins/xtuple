...
mywindow.setWindowTitle(qsTr("Labor Variance By Work Center"));
mywindow.setListLabel(qsTr("Labor Variance"));
mywindow.setReportName("LaborVarianceByWorkCenter");
...
{
   params.all_workcenters = qsTr("All Work Centers");
   return true;
}
